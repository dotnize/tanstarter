...
Better Auth is currently configured for OAuth2 with GitHub, Google, and Discord, but can be easily updated to use other providers.
...
These scripts in [package.json](./package.json#L5) use **pnpm** by default, but you can update them to use your preferred package manager.
